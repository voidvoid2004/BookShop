            ...
            <div class="col-9">
                <div class="card" style="margin-top: 20px;">
                    <div class="card-header">
                        ...
                        <!-- Modal -->
                        <div class="modal fade " id="add_book_btn" data-bs-backdrop="static" data-bs-keyboard="false"
                            tabindex="-1">
                                                ...
                                                <div class=" modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea v-model="book.description" class="form-control"
                                                                id="add-book-description" rows="3"
                                                                placeholder="请输入书的简介"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
